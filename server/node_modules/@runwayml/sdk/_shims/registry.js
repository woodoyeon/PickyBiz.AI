...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import '@runwayml/sdk/shims/${shims.kind}'\` before importing anything else from @runwayml/sdk`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import '@runwayml/sdk/shims/${shims.kind}'\` after \`import '@runwayml/sdk/shims/${exports.kind}'\``);
    }
